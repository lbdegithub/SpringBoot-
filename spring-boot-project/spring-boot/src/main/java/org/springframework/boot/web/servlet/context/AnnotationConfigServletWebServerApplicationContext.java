...
public class AnnotationConfigServletWebServerApplicationContext extends ServletWebServerApplicationContext
	...
	/**
	 * LB-TODO
	 *  spring boot 启动时，对应servlet类型的web环境的 Spring上下文
	 *  初始化完毕之后 ，下一步就是调用org.springframework.context.support.AbstractApplicationContext#refresh()刷新上下文
	 * Create a new {@link AnnotationConfigServletWebServerApplicationContext} that needs
	 * to be populated through {@link #register} calls and then manually
	 * {@linkplain #refresh refreshed}.
	 */
	public AnnotationConfigServletWebServerApplicationContext() {
		// 初始化SpringBean的加载器，用来替换ClassPathBeanDefinitionScanner，生成BeanDefinition
		this.reader = new AnnotatedBeanDefinitionReader(this);
		// 在类路径上检测到候选bean的 bean定义扫描器
